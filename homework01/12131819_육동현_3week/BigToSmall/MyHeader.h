...
// Print => This function controls the input guide
...
{
	for (int i = 0; i < 6; i++) // Outer loop controls the index of stanard of comparison.
		for (int j = i; j < 6; j++) // Inner loop controls the index of comparison target.
